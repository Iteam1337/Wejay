...
angular.module('wejay').factory('socketIo',function($window) {
...
angular.module("wejay").run(["$templateCache", function($templateCache) {

  $templateCache.put("partial/room/room.html",
    "\n" +
    ...
    "      <ul>\n" +
    "        <li ng-repeat=\"user in activeUsers | orderBy:lastPlayDate\">\n" +
  ...
  $templateCache.put("directive/playlist/playlist.html",
    "<div class=\"playlist\">\n" +
    ...
    "        </div>\n" +
    "      </div>\n" +
    "      <img ng-src=\"{{ song.user.image }}\" ng-click=\"skip(song)\" class=\"user\">\n" +
    "      <div class=\"duration\">{{ song.time }}</div>\n" +
    "    </li>\n" +
    "  </ul>\n" +
    "  <div class=\"totals\" ng-show=\"totalDuration\">\n" +
  ...
  $templateCache.put("directive/toplist/toplist.html",
    "<div id=\"toplist\">\n" +
    "  <h3>Your top tracks</h3>\n" +
    "  <ul>\n" +
    "    <li ng-repeat=\"track in toplist\">\n" +
    "      <a ng-click=\"queueTrack(track)\">\n" +
    "        <img ng-src=\"{{ track.image }}\">\n" +
    "      </a>\n" +
    "      <div class=\"info\">\n" +
    "        <a class=\"artist\" ng-href=\"{{ track.artists[0].uri }}\">{{ track.artists[0].name }}</a>\n" +
    "        <a class=\"track\" ng-click=\"queueTrack(track)\">{{ track.name }}</a>\n" +
    "        <span class=\"star\">{{ track.starred }}</span>\n" +
    "      </div>\n" +
    "    </li>\n" +
    "  </ul>\n" +
    "</div>"
